...
normalized as (
    select
        id,
        record_hash,
        entity_information::jsonb as entity_information_json,
        methodology::jsonb as methodology_json,
        industry_risk::jsonb as industry_risk_json,
        business_risk_profile::jsonb as business_risk_profile_json,
        financial_risk_profile::jsonb as financial_risk_profile_json,
        credit_metrics::jsonb as credit_metrics_json,
        entity_name,
        country,
        industry,
        business_risk_score,
...
select
    ...
    rating_date,
    coalesce(rating_date, ingested_at::date) as assessment_date,
    source_system,
    document_version,
    ingested_at,
    methodology_json,
